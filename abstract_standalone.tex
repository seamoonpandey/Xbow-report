...
\begin{center}
{\LARGE\textbf{RedSentinel}}\\[6pt]
{\large Transformer-Based Generation and Obfuscation of\\[3pt]
Context-Aware XSS Payloads}\\[14pt]
Bipin Bhattarai \ \ \textperiodcentered \ \ Seamoon Pandey \ \ \textperiodcentered \ \ Sworup Bhandari\\[5pt]
{\color{rulegray}\small Tribhuvan University, Institute of Engineering \ \ \textperiodcentered \ \ 2026}
\end{center}
...
\noindent{\color{rulegray}\small\textbf{Keywords:} Cross-Site Scripting, XSS, Machine Learning, Transformer Models, Adversarial Payload Generation, Web Security, Automated Penetration Testing, Obfuscation, Context-Aware Attack Generation, BullMQ, Uvicorn, Pydantic, Playwright}
